...
#@ String (label = "Name of LUT", value = "Green") customLUT
#@ String (label = "End of filename without filenumber", value = "_mGreenLantern_") customEnd
...
list = getFileList(input);
list = Array.sort(list);
endIndex=indexOf(list[1],customEnd);
